...
> GUI操作から脱却し、設計をコード・構造・履歴として管理するための設計思想と実践。
...
> 表示技術と状態遷移を軸に、壊れないゲーム構造を組み立てる試行。
...
> AIをエージェント／FSMとして扱い、歴史を「設計可能なシステム」に落とす試み。
